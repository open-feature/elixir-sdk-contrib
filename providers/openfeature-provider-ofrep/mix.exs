defmodule OpenFeature.Provider.OFREP.MixProject do
  ...
  def project do
    [
      app: :open_feature_provider_ofrep,
      version: @version,
      elixir: "~> 1.14",
      ...
      # Docs
      name: "OpenFeature OFREP",
      source_url: @git_repo,
      homepage_url: "https://openfeature.dev",
      docs: docs(),

      # Hex
      description: "OpenFeature OFREP provider",
      package: package()
    ]
  end
  ...
  defp package do
    [
      ...
      links: %{
        "GitHub" => @git_repo,
        "Changelog" => "https://hexdocs.pm/open_feature_provider_ofrep/changelog.html"
      }
    ]
  end
end
